  ...
  const [messages, setMessages] = useState([
    {
      ...
      text: language === 'Français' 
        ? "Bonjour ! Je suis l'Agronome IA de PACNOVA, fonctionnant 100% hors-ligne. Comment puis-je aider votre ferme aujourd'hui ?"
        : "Hello! I am the PACNOVA AI Agronomist, running 100% offline. How can I help your farm today?"
    }
  ]);
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          <Text style={styles.headerTitle}>PACNOVA {t.chatAi}</Text>
