  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>PACNOVA {language === 'Français' ? 'Administration' : 'Admin Control'}</Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.welcomeCard}>
          ...
          <Text style={styles.welcomeText}>
            {language === 'Français' 
              ? 'Le système PACNOVA fonctionne parfaitement.' 
              : 'PACNOVA System is operating perfectly.'}
          </Text>
        </View>
