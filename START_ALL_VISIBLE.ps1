...
Write-Host ""
Start-Process powershell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -NoExit -Command `"Set-Location '$rootDir\expo-mobile'; `$env:REACT_NATIVE_PACKAGER_HOSTNAME='192.168.1.81'; Write-Host ''; Write-Host '╔════════════════════════════════════════╗' -ForegroundColor Cyan; Write-Host '║                                        ║' -ForegroundColor Cyan; Write-Host '║  PACNOVA MOBILE APP - EXPO QR CODE      ║' -ForegroundColor Cyan; Write-Host '║                                        ║' -ForegroundColor Cyan; Write-Host '║  📱 Scan QR Code with Expo Go App      ║' -ForegroundColor Cyan; Write-Host '║                                        ║' -ForegroundColor Cyan; Write-Host '║  ✓ Phone on same WiFi as PC            ║' -ForegroundColor Cyan; Write-Host '║  ✓ LAN Mode (192.168.1.81)             ║' -ForegroundColor Cyan; Write-Host '║                                        ║' -ForegroundColor Cyan; Write-Host '╚════════════════════════════════════════╝' -ForegroundColor Cyan; Write-Host ''; npm start`"" -WindowStyle Normal
